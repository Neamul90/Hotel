            ...
            <div class="widget green">
                ...
                <div class="widget-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="span6 " name="blog_short_description" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">News Long Description</label>
                        <div class="controls">
                            <textarea class="span6 " name="blog_long_description" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
...
<script src="{{asset('admin_assets/code.jquery.com/ui/1.10.3/jquery-ui.js')}}"></script>
<script src="{{asset('admin_assets/js/jQuery.dualListBox-1.3.js')}}" language="javascript" type="text/javascript"></script>
