...
<div id="sidebar" class="nav-collapse collapse">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sub-menu">
            ...
            <ul class="sub">
                <li><a class="" href="{{ URL::to('/add_admin') }}">Add Admin</a></li>
        ...
        <li class="sub-menu">
            ...
            <ul class="sub">
                <li><a class="" href="{{ URL::to('/category') }}">Category</a></li>
                <li><a class="" href="{{ URL::to('/news') }}">News</a></li>
        ...
        <li>
            <a class="" href="{{ URL::to('/contact_us') }}">
                <i class="icon-user"></i>
